...
2020-07-29 
Добавлена поддержка встроенных датчиков (напряжения, тока, мощности, температуры, влажности, CO2)
В конфиге есть примеры использования: температура/влажность/CO2 у Бризера и напряжения/тока/мощности на выключателе коридора
